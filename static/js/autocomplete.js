(function() {
  var Autocompleter, Bag42Completer, CategoryPrediction, GeocoderCompleter, GoogleCompleter, GoogleLocation, HistoryCompleter, Location, LocationHistory, LocationPrediction, OSMCompleter, POICategoryCompleter, Prediction, RemoteAutocompleter, accent_insensitive_pattern, completers, generate_area_completers, get_all_predictions, google_url, hel_geocoder_address_url, letters_to_accents, navigate_to_location, navigate_to_poi, nominatim_url, pred_list, render_autocomplete_results, supported_completers, test_completer, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  RemoteAutocompleter = (function(_super) {
    ...
    RemoteAutocompleter.prototype.submit_prediction_failure = function() {
  ...
  GeocoderCompleter = (function(_super) {
    ...
    function GeocoderCompleter() {
      _ref1 = GeocoderCompleter.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    GeocoderCompleter.prototype.fetch_addresses = function() {
      ...
      this.xhr.fail(function() {
        return _this.submit_prediction_failure();
      });
      return this.xhr.done(function(data) {
  ...
  Bag42Completer = (function(_super) {
    ...
    function Bag42Completer() {
      _ref2 = Bag42Completer.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
    ...
    Bag42Completer.prototype.fetch_results = function() {
      ...
      return this.xhr.done(function(data) {
        var adr, coords, loc, loc_list, objs, _i, _len, _ref3;
        objs = data.results;
        loc_list = [];
        _ref3 = objs || [];
  ...
  GoogleCompleter = (function(_super) {
    ...
    function GoogleCompleter() {
      _ref3 = GoogleCompleter.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  OSMCompleter = (function(_super) {
    ...
    function OSMCompleter() {
      _ref4 = OSMCompleter.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    OSMCompleter.prototype.fetch_results = function() {
      ...
      return this.xhr.done(function(data) {
        var addr, display, is_street, loc, loc_list, name, number, obj, part, pattern, query_filter_patterns, street, suburb, type, typename, _i, _len, _ref5, _ref6;
        loc_list = [];
        query_filter_patterns = (function() {
          var _i, _len, _ref5, _results;
          _ref5 = this.query.split(" ");
          _results = [];
        ...
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          ...
          display = "";
          name = null;
          if (((_ref5 = area.cities) != null ? _ref5.length : void 0) && !(_ref6 = addr.city, __indexOf.call(area.cities, _ref6) >= 0)) {
            continue;
          }
          type = obj.type;
          if (type === "yes") {
  ...
  POICategoryCompleter = (function(_super) {
    ...
    function POICategoryCompleter() {
      _ref5 = POICategoryCompleter.__super__.constructor.apply(this, arguments);
      return _ref5;
    }

    POICategoryCompleter.prototype.get_predictions = function(query, callback, args) {
      var cat, pred_list, q, ss, _i, _len, _ref6;
      if (!query.length) {
        return;
      }
      pred_list = [];
      q = query.toLowerCase();
      _ref6 = citynavi.poi_categories;
  ...
  HistoryCompleter = (function(_super) {
    ...
    function HistoryCompleter() {
      _ref6 = HistoryCompleter.__super__.constructor.apply(this, arguments);
      return _ref6;
    }

    HistoryCompleter.prototype.get_predictions = function(query, callback, args) {
      var location, pred_list, _i, _ref7;
      console.log("historycompleter");
      pred_list = [];
      _ref7 = location_history.history;
      for (_i = _ref7.length - 1; _i >= 0; _i += -1) {
        location = _ref7[_i];
  ...
  generate_area_completers = function(area) {
    var id, _i, _len, _ref7, _results;
    _ref7 = area.autocompletion_providers;
    _results = [];
  ...
  get_all_predictions = function(input, callback, callback_options) {
    var c, deferred, i, prediction_callback, prev_deferred, _i, _len, _results;
    input = $.trim(input);
    ...
    for (i = _i = 0, _len = completers.length; _i < _len; i = ++_i) {
      ...
      prediction_callback = (function(i, deferred, prev_deferred) {
        return function(_options, new_preds) {
          return prev_deferred.always(function() {
            return deferred.resolve(callback_options, new_preds);
          });
        };
      })(i, deferred, prev_deferred);
      c.get_predictions(input, prediction_callback, {});
      _results.push(prev_deferred = deferred);
    }
    return _results;
  };
  ...
  render_autocomplete_results = function(args, new_preds) {
    var $el, $input, $ul, key, pred, seen, seen_addresses, seen_streets, _i, _len, _ref7, _ref8;
    $ul = args.$ul;
    $input = args.$input;
    ...
    for (_i = 0, _len = pred_list.length; _i < _len; _i++) {
      pred = pred_list[_i];
      if ((_ref7 = pred.location) != null ? _ref7.street : void 0) {
      ...
      key = pred.type + "|" + ((_ref8 = pred.location) != null ? _ref8.icon : void 0) + "|" + pred.name;
      if (pred.rendered) {
        seen[key] = true;
        continue;
      }
