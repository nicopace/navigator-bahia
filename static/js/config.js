(function() {
  var bahiablanca, defaults, hel_geocoder_base_url, hel_servicemap_base_url, helsinki, hsl_colors, manchester, nl;
  ...
  bahiablanca = {
    ...
    country: "ar",
    cities: ["Bahía Blanca"],
    google_autocomplete_append: "Bahía Blanca",
  ...
  citynavi.set_config("bahiablanca");
